    ...
    <div className="mx-auto max-w-2xl">
      ...
      <header className="mb-6 space-y-2">
        ...
        <p className="text-sm text-white/60">
          One-shot liquidity-seeder for the two launch pools: ETI/ETX and EGAZ/ETX. Signs with your
          connected wallet — no private key ever leaves MetaMask. Intended to be run once per chain,
          by the project operator, directly after{' '}
          <a className="text-emerald-400 underline" href="/deploy/etx">
            /deploy/etx
          </a>
          .
        </p>
