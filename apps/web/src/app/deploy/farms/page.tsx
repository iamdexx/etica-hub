    ...
    <div className="mx-auto max-w-2xl">
      ...
      <header className="mb-6 space-y-2">
        ...
        <p className="text-sm text-white/60">
          One-shot browser deployer for <span className="font-mono">ETXFarms</span>, the LP staking
          contract that receives the 10% farms slice of every Harvester cycle. Signs with your
          connected wallet — no private key ever leaves MetaMask. Run once per chain, then paste the
          deployed address into <span className="font-mono">packages/shared/src/addresses.ts</span>{' '}
          and wire it into the Harvester via{' '}
