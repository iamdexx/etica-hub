    ...
    <div className="space-y-6">
      ...
      <section className="flex flex-col gap-4 rounded-3xl border border-white/10 bg-white/[0.02] p-6 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-tight md:text-4xl">Transactions</h1>
          <p className="mt-2 max-w-2xl text-sm text-white/60">
            Latest Etica mainnet transactions from a bounded public-RPC block window. Full historical search can be layered in later with a lightweight indexer.
          </p>
        </div>
