...
// ─────────────────────────────────────────────────────────────────────────────
// Etica — RESLockVault (packages/contracts/src/wres/RESLockVault.sol)
// ─────────────────────────────────────────────────────────────────────────────
export const RES_LOCK_VAULT_ABI = [
  {
    type: 'event',
    name: 'Locked',
    anonymous: false,
    inputs: [
      { name: 'resTokenId', type: 'uint256', indexed: true },
      { name: 'owner', type: 'address', indexed: true },
      { name: 'tronRecipient', type: 'address', indexed: true },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'viaKeeper', type: 'bool', indexed: false },
    ],
  },
  {
    type: 'function',
    ...
    outputs: [
      ...
      { name: 'tronRecipient', type: 'address' },
      { name: 'lockedAt', type: 'uint64' },
      { name: 'unlockReadyAt', type: 'uint64' },
  ...
  },
  {
    ...
    inputs: [{ name: 'resTokenId', type: 'uint256' }],
    outputs: [],
  },
  {
    type: 'function',
